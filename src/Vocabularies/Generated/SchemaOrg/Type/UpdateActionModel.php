...
final class UpdateActionModel
{
    public const DESCRIPTION = 'The act of managing by changing/editing the state of the object.';
    public const LABEL = 'UpdateAction';
    public const NAME = 'schema:UpdateAction';
