...
final class HealthAndBeautyBusinessModel
{
    public const DESCRIPTION = 'Health and beauty.';
    public const LABEL = 'HealthAndBeautyBusiness';
    public const NAME = 'schema:HealthAndBeautyBusiness';
