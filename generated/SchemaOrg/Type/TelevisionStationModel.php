...
final class TelevisionStationModel
{
    public const DESCRIPTION = 'A television station.';
    public const LABEL = 'TelevisionStation';
    public const NAME = 'schema:TelevisionStation';
