...
final class IncludedRiskFactorModel
{
    ...
    public const VALUES = ['MedicalRiskFactorModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\MedicalRiskFactorModel'];
    public const TYPES = ['MedicalRiskEstimator' => 'Jolicode\Vocabularies\SchemaOrg\Type\MedicalRiskEstimatorModel'];
