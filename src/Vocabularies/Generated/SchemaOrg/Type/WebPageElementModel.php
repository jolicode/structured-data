...
final class WebPageElementModel
{
    public const DESCRIPTION = 'A web page element, like a table or an image.';
    public const LABEL = 'WebPageElement';
    public const NAME = 'schema:WebPageElement';
