...
final class ParkingFacilityModel
{
    public const DESCRIPTION = 'A parking lot or other parking facility.';
    public const LABEL = 'ParkingFacility';
    public const NAME = 'schema:ParkingFacility';
