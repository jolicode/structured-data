...
final class IncludesAttractionModel
{
    ...
    public const VALUES = ['TouristAttractionModel' => 'SchemaOrg\\Type\\TouristAttractionModel'];
    public const TYPES = ['TouristDestination' => 'SchemaOrg\\Type\\TouristDestinationModel'];
}
