...
final class FulfillmentTypeEnumerationModel
{
    public const DESCRIPTION = 'A type of product fulfillment.';
    public const LABEL = 'FulfillmentTypeEnumeration';
    public const NAME = 'schema:FulfillmentTypeEnumeration';
