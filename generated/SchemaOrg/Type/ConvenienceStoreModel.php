...
final class ConvenienceStoreModel
{
    public const DESCRIPTION = 'A convenience store.';
    public const LABEL = 'ConvenienceStore';
    public const NAME = 'schema:ConvenienceStore';
