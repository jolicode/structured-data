...
final class PerformingGroupModel
{
    public const DESCRIPTION = 'A performance group, such as a band, an orchestra, or a circus.';
    public const LABEL = 'PerformingGroup';
    public const NAME = 'schema:PerformingGroup';
