...
final class EmploymentAgencyModel
{
    public const DESCRIPTION = 'An employment agency.';
    public const LABEL = 'EmploymentAgency';
    public const NAME = 'schema:EmploymentAgency';
