...
final class OptionModel
{
    ...
    public const TYPES = ['ChooseAction' => 'JoliCode\StructuredData\Vocabularies\Generated\SchemaOrg\Type\ChooseActionModel'];
    public const IS_PART_OF = [];
    public const SOURCE = [];
    public const SUPERSEDED_BY = 'actionOption';
}
