...
final class ShoppingCenterModel
{
    public const DESCRIPTION = 'A shopping center or mall.';
    public const LABEL = 'ShoppingCenter';
    public const NAME = 'schema:ShoppingCenter';
