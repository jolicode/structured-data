...
final class HealthPlanNetworkIdModel
{
    ...
    public const TYPES = ['HealthPlanNetwork' => 'Jolicode\SchemaOrg\Type\HealthPlanNetworkModel', 'MedicalOrganization' => 'Jolicode\SchemaOrg\Type\MedicalOrganizationModel'];
