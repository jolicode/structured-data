...
final class RadioSeriesModel
{
    public const DESCRIPTION = 'CreativeWorkSeries dedicated to radio broadcast and associated online delivery.';
    public const LABEL = 'RadioSeries';
