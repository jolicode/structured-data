...
final class RoofingContractorModel
{
    public const DESCRIPTION = 'A roofing contractor.';
    public const LABEL = 'RoofingContractor';
    public const NAME = 'schema:RoofingContractor';
