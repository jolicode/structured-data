...
final class HobbyShopModel
{
    public const DESCRIPTION = 'A store that sells materials useful or necessary for various hobbies.';
    public const LABEL = 'HobbyShop';
    public const NAME = 'schema:HobbyShop';
