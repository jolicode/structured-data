...
final class ItemPageModel
{
    public const DESCRIPTION = 'A page devoted to a single item, such as a particular product or hotel.';
    public const LABEL = 'ItemPage';
    public const NAME = 'schema:ItemPage';
