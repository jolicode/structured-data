...
final class BeneficiaryBankModel
{
    ...
    public const VALUES = ['BankOrCreditUnionModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\BankOrCreditUnionModel', 'TextModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\TextModel'];
    public const TYPES = ['MoneyTransfer' => 'Jolicode\Vocabularies\SchemaOrg\Type\MoneyTransferModel'];
