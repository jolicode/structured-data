...
final class WatchActionModel
{
    public const DESCRIPTION = 'The act of consuming dynamic/moving visual content.';
    public const LABEL = 'WatchAction';
    public const NAME = 'schema:WatchAction';
