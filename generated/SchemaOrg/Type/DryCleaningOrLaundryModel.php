...
final class DryCleaningOrLaundryModel
{
    public const DESCRIPTION = 'A dry-cleaning business.';
    public const LABEL = 'DryCleaningOrLaundry';
    public const NAME = 'schema:DryCleaningOrLaundry';
