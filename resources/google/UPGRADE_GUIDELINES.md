...
This will crawle the google docs and generate a full report of all the updates found in the google documentation.

### 2. Update the manifest
We use a [manifest](resources/google/google-types.json) to keep track of what we currently support.
...
You may need to add a completely new type. Strictly follow the structure we use. There is [a dedicated readme](resources/google/structured-data/README.md) to help understanding our JSON files.
...
### 4. Validate special rules wiring
...
### 9. CI note for `castor google:generation:verify-docs`:
