...
final class HowToModel
{
    public const DESCRIPTION = 'Instructions that explain how to achieve a result by performing a sequence of steps.';
    public const LABEL = 'HowTo';
    public const NAME = 'schema:HowTo';
