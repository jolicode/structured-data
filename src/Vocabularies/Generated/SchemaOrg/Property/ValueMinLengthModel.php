...
final class ValueMinLengthModel
{
    public const DESCRIPTION = 'Specifies the minimum allowed range for number of characters in a literal value.';
    public const LABEL = 'valueMinLength';
    public const NAME = 'schema:valueMinLength';
