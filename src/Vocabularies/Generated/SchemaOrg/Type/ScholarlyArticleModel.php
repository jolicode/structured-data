...
final class ScholarlyArticleModel
{
    public const DESCRIPTION = 'A scholarly article.';
    public const LABEL = 'ScholarlyArticle';
    public const NAME = 'schema:ScholarlyArticle';
