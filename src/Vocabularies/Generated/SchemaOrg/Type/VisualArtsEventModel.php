...
final class VisualArtsEventModel
{
    public const DESCRIPTION = 'Event type: Visual arts event.';
    public const LABEL = 'VisualArtsEvent';
    public const NAME = 'schema:VisualArtsEvent';
