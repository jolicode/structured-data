...
final class AudioObjectModel
{
    public const DESCRIPTION = 'An audio file.';
    public const LABEL = 'AudioObject';
    public const NAME = 'schema:AudioObject';
    public const PARENTS = ['MediaObjectModel' => 'JoliCode\StructuredData\Vocabularies\Generated\SchemaOrg\Type\MediaObjectModel'];
