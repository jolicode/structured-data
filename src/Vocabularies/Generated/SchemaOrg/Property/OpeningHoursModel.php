...
final class OpeningHoursModel
{
    ...
    public const TYPES = ['CivicStructure' => 'Jolicode\Vocabularies\SchemaOrg\Type\CivicStructureModel', 'LocalBusiness' => 'Jolicode\Vocabularies\SchemaOrg\Type\LocalBusinessModel'];
