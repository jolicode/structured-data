...
final class FinancialServiceModel
{
    public const DESCRIPTION = 'Financial services business.';
    public const LABEL = 'FinancialService';
    public const NAME = 'schema:FinancialService';
