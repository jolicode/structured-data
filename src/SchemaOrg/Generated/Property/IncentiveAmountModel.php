...
{
    public const DESCRIPTION = 'Describes the amount that can be redeemed from this incentive.
...
<li>Use [[LoanOrCredit]] for loans/credits.</li>
    ...
    public const VALUES = ['LoanOrCreditModel' => 'Jolicode\SchemaOrg\Type\LoanOrCreditModel', 'QuantitativeValueModel' => 'Jolicode\SchemaOrg\Type\QuantitativeValueModel', 'UnitPriceSpecificationModel' => 'Jolicode\SchemaOrg\Type\UnitPriceSpecificationModel'];
