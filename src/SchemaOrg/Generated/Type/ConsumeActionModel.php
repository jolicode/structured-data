...
final class ConsumeActionModel
{
    public const DESCRIPTION = 'The act of ingesting information/resources/food.';
    public const LABEL = 'ConsumeAction';
    public const NAME = 'schema:ConsumeAction';
