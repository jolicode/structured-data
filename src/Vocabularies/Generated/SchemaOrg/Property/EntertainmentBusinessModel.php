...
final class EntertainmentBusinessModel
{
    ...
    public const VALUES = ['EntertainmentBusinessModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\EntertainmentBusinessModel'];
    public const TYPES = ['PerformAction' => 'Jolicode\Vocabularies\SchemaOrg\Type\PerformActionModel'];
