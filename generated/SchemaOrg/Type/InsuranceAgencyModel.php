...
final class InsuranceAgencyModel
{
    public const DESCRIPTION = 'An Insurance agency.';
    public const LABEL = 'InsuranceAgency';
    public const NAME = 'schema:InsuranceAgency';
