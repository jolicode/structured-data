...
final class SuggestedAnswerModel
{
    ...
    public const VALUES = ['AnswerModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\AnswerModel', 'ItemListModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\ItemListModel'];
    public const TYPES = ['Question' => 'Jolicode\Vocabularies\SchemaOrg\Type\QuestionModel'];
