...
final class PerformingArtsTheaterModel
{
    public const DESCRIPTION = 'A theater or other performing art center.';
    public const LABEL = 'PerformingArtsTheater';
    public const NAME = 'schema:PerformingArtsTheater';
    public const PARENTS = ['CivicStructureModel' => 'JoliCode\StructuredData\Vocabularies\Generated\SchemaOrg\Type\CivicStructureModel'];
