...
final class IsUnlabelledFallbackModel
{
    ...
    public const TYPES = ['DeliveryTimeSettings' => 'Jolicode\Vocabularies\SchemaOrg\Type\DeliveryTimeSettingsModel', 'ShippingRateSettings' => 'Jolicode\Vocabularies\SchemaOrg\Type\ShippingRateSettingsModel'];
