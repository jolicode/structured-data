...
final class MusicVideoObjectModel
{
    public const DESCRIPTION = 'A music video file.';
    public const LABEL = 'MusicVideoObject';
    public const NAME = 'schema:MusicVideoObject';
