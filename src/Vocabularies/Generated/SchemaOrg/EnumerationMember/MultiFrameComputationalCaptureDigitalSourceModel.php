...
final class MultiFrameComputationalCaptureDigitalSourceModel
{
    ...
    public const LABEL = 'MultiFrameComputationalCaptureDigitalSource';
    public const NAME = 'schema:MultiFrameComputationalCaptureDigitalSource';
