...
final class ExpectsAcceptanceOfModel
{
    ...
    public const TYPES = ['ActionAccessSpecification' => 'Jolicode\Vocabularies\SchemaOrg\Type\ActionAccessSpecificationModel', 'ConsumeAction' => 'Jolicode\Vocabularies\SchemaOrg\Type\ConsumeActionModel', 'MediaSubscription' => 'Jolicode\Vocabularies\SchemaOrg\Type\MediaSubscriptionModel'];
