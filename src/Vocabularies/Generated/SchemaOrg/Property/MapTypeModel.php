...
final class MapTypeModel
{
    ...
    public const VALUES = ['MapCategoryTypeModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\MapCategoryTypeModel'];
    public const TYPES = ['Map' => 'Jolicode\Vocabularies\SchemaOrg\Type\MapModel'];
