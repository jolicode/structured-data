...
final class StadiumOrArenaModel
{
    ...
    public const PARENTS = ['CivicStructureModel' => 'Jolicode\SchemaOrg\Type\CivicStructureModel', 'SportsActivityLocationModel' => 'Jolicode\SchemaOrg\Type\SportsActivityLocationModel'];
