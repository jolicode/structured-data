...
final class MensClothingStoreModel
{
    public const DESCRIPTION = 'A men\'s clothing store.';
    public const LABEL = 'MensClothingStore';
    public const NAME = 'schema:MensClothingStore';
