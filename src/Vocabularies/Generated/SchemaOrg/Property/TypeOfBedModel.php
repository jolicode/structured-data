...
final class TypeOfBedModel
{
    ...
    public const VALUES = ['BedTypeModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\BedTypeModel', 'TextModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\TextModel'];
    public const TYPES = ['BedDetails' => 'Jolicode\Vocabularies\SchemaOrg\Type\BedDetailsModel'];
