...
final class VisualArtworkModel
{
    public const DESCRIPTION = 'A work of art that is primarily visual in character.';
    public const LABEL = 'VisualArtwork';
    public const NAME = 'schema:VisualArtwork';
