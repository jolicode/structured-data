...
final class SheetMusicModel
{
    public const DESCRIPTION = 'Printed music, as opposed to performed or recorded music.';
    public const LABEL = 'SheetMusic';
    public const NAME = 'schema:SheetMusic';
