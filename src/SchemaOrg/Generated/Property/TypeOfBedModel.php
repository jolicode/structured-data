...
final class TypeOfBedModel
{
    ...
    public const VALUES = ['BedTypeModel' => 'Jolicode\SchemaOrg\Type\BedTypeModel', 'TextModel' => 'Jolicode\SchemaOrg\Type\TextModel'];
    public const TYPES = ['BedDetails' => 'Jolicode\SchemaOrg\Type\BedDetailsModel'];
}
