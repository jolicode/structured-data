...
final class PoliticalPartyModel
{
    public const DESCRIPTION = 'Organization: Political Party.';
    public const LABEL = 'PoliticalParty';
    public const NAME = 'schema:PoliticalParty';
    ...
    public const SOURCE = ['https://github.com/schemaorg/schemaorg/issues/3282'];
