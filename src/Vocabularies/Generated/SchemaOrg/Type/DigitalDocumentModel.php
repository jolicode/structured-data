...
final class DigitalDocumentModel
{
    public const DESCRIPTION = 'An electronic file or document.';
    public const LABEL = 'DigitalDocument';
    public const NAME = 'schema:DigitalDocument';
