...
final class TouristInformationCenterModel
{
    public const DESCRIPTION = 'A tourist information center.';
    public const LABEL = 'TouristInformationCenter';
    public const NAME = 'schema:TouristInformationCenter';
