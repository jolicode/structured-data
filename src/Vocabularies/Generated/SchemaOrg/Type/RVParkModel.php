...
final class RVParkModel
{
    public const DESCRIPTION = 'A place offering space for "Recreational Vehicles", Caravans, mobile homes and the like.';
    public const LABEL = 'RVPark';
    public const NAME = 'schema:RVPark';
