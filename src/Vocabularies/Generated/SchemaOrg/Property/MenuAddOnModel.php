...
final class MenuAddOnModel
{
    ...
    public const VALUES = ['MenuItemModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\MenuItemModel', 'MenuSectionModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\MenuSectionModel'];
    public const TYPES = ['MenuItem' => 'Jolicode\Vocabularies\SchemaOrg\Type\MenuItemModel'];
