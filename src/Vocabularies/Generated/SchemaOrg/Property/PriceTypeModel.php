...
final class PriceTypeModel
{
    ...
    public const VALUES = ['PriceTypeEnumerationModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\PriceTypeEnumerationModel', 'TextModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\TextModel'];
    public const TYPES = ['CompoundPriceSpecification' => 'Jolicode\Vocabularies\SchemaOrg\Type\CompoundPriceSpecificationModel', 'UnitPriceSpecification' => 'Jolicode\Vocabularies\SchemaOrg\Type\UnitPriceSpecificationModel'];
