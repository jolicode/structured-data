...
final class GovernmentOrganizationModel
{
    public const DESCRIPTION = 'A governmental organization or agency.';
    public const LABEL = 'GovernmentOrganization';
    public const NAME = 'schema:GovernmentOrganization';
