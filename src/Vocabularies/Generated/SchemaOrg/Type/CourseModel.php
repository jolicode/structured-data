...
final class CourseModel
{
    ...
    public const PARENTS = ['CreativeWorkModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\CreativeWorkModel', 'LearningResourceModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\LearningResourceModel'];
