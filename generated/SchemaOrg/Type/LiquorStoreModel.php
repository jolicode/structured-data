...
final class LiquorStoreModel
{
    public const DESCRIPTION = 'A shop that sells alcoholic drinks such as wine, beer, whisky and other spirits.';
    public const LABEL = 'LiquorStore';
    public const NAME = 'schema:LiquorStore';
