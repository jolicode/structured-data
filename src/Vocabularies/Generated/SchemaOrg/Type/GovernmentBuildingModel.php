...
final class GovernmentBuildingModel
{
    public const DESCRIPTION = 'A government building.';
    public const LABEL = 'GovernmentBuilding';
    public const NAME = 'schema:GovernmentBuilding';
