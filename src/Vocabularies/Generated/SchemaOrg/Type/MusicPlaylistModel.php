...
final class MusicPlaylistModel
{
    public const DESCRIPTION = 'A collection of music tracks in playlist form.';
    public const LABEL = 'MusicPlaylist';
    public const NAME = 'schema:MusicPlaylist';
