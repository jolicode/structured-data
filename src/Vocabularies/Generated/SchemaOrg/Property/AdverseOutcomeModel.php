...
final class AdverseOutcomeModel
{
    ...
    public const TYPES = ['MedicalDevice' => 'Jolicode\Vocabularies\SchemaOrg\Type\MedicalDeviceModel', 'TherapeuticProcedure' => 'Jolicode\Vocabularies\SchemaOrg\Type\TherapeuticProcedureModel'];
