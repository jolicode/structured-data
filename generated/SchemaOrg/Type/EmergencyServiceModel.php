...
final class EmergencyServiceModel
{
    public const DESCRIPTION = 'An emergency service, such as a fire station or ER.';
    public const LABEL = 'EmergencyService';
    public const NAME = 'schema:EmergencyService';
