...
final class SportingGoodsStoreModel
{
    public const DESCRIPTION = 'A sporting goods store.';
    public const LABEL = 'SportingGoodsStore';
    public const NAME = 'schema:SportingGoodsStore';
