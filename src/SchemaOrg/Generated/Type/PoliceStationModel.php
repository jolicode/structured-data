...
final class PoliceStationModel
{
    ...
    public const PARENTS = ['CivicStructureModel' => 'Jolicode\SchemaOrg\Type\CivicStructureModel', 'EmergencyServiceModel' => 'Jolicode\SchemaOrg\Type\EmergencyServiceModel'];
