...
final class AutomotiveBusinessModel
{
    public const DESCRIPTION = 'Car repair, sales, or parts.';
    public const LABEL = 'AutomotiveBusiness';
    public const NAME = 'schema:AutomotiveBusiness';
