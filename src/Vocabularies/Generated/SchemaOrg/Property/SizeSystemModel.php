...
final class SizeSystemModel
{
    ...
    public const VALUES = ['SizeSystemEnumerationModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\SizeSystemEnumerationModel', 'TextModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\TextModel'];
