...
final class LiteraryEventModel
{
    public const DESCRIPTION = 'Event type: Literary event.';
    public const LABEL = 'LiteraryEvent';
    public const NAME = 'schema:LiteraryEvent';
