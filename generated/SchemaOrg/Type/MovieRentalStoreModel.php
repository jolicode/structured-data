...
final class MovieRentalStoreModel
{
    public const DESCRIPTION = 'A movie rental store.';
    public const LABEL = 'MovieRentalStore';
    public const NAME = 'schema:MovieRentalStore';
