...
final class PickupLocationModel
{
    ...
    public const TYPES = ['RentalCarReservation' => 'Jolicode\Vocabularies\SchemaOrg\Type\RentalCarReservationModel', 'TaxiReservation' => 'Jolicode\Vocabularies\SchemaOrg\Type\TaxiReservationModel'];
