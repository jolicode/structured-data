...
final class HostingOrganizationModel
{
    ...
    public const TYPES = ['MemberProgram' => 'Jolicode\Vocabularies\SchemaOrg\Type\MemberProgramModel', 'ProgramMembership' => 'Jolicode\Vocabularies\SchemaOrg\Type\ProgramMembershipModel'];
