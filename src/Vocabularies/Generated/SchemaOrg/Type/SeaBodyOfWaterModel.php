...
final class SeaBodyOfWaterModel
{
    public const DESCRIPTION = 'A sea (for example, the Caspian sea).';
    public const LABEL = 'SeaBodyOfWater';
    public const NAME = 'schema:SeaBodyOfWater';
