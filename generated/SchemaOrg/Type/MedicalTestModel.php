...
final class MedicalTestModel
{
    public const DESCRIPTION = 'Any medical test, typically performed for diagnostic purposes.';
    public const LABEL = 'MedicalTest';
    public const NAME = 'schema:MedicalTest';
