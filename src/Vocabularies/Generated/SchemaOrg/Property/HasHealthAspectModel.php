...
final class HasHealthAspectModel
{
    ...
    public const VALUES = ['HealthAspectEnumerationModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\HealthAspectEnumerationModel'];
    public const TYPES = ['HealthTopicContent' => 'Jolicode\Vocabularies\SchemaOrg\Type\HealthTopicContentModel'];
