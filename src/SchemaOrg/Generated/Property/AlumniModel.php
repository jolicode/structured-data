...
final class AlumniModel
{
    ...
    public const TYPES = ['EducationalOrganization' => 'Jolicode\SchemaOrg\Type\EducationalOrganizationModel', 'Organization' => 'Jolicode\SchemaOrg\Type\OrganizationModel'];
}
