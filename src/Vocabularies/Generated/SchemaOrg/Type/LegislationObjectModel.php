...
final class LegislationObjectModel
{
    ...
    public const PARENTS = ['LegislationModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\LegislationModel', 'MediaObjectModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\MediaObjectModel'];
