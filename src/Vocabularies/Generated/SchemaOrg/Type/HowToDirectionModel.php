...
final class HowToDirectionModel
{
    ...
    public const PARENTS = ['CreativeWorkModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\CreativeWorkModel', 'ListItemModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\ListItemModel'];
