...
final class PaymentStatusModel
{
    ...
    public const VALUES = ['PaymentStatusTypeModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\PaymentStatusTypeModel', 'TextModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\TextModel'];
