...
final class ListenActionModel
{
    public const DESCRIPTION = 'The act of consuming audio content.';
    public const LABEL = 'ListenAction';
    public const NAME = 'schema:ListenAction';
