...
final class ShippingRateModel
{
    ...
    public const VALUES = ['MonetaryAmountModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\MonetaryAmountModel', 'ShippingRateSettingsModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\ShippingRateSettingsModel'];
