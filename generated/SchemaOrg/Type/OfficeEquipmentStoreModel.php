...
final class OfficeEquipmentStoreModel
{
    public const DESCRIPTION = 'An office equipment store.';
    public const LABEL = 'OfficeEquipmentStore';
    public const NAME = 'schema:OfficeEquipmentStore';
