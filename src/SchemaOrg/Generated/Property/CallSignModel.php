...
final class CallSignModel
{
    ...
    public const TYPES = ['BroadcastService' => 'Jolicode\SchemaOrg\Type\BroadcastServiceModel', 'Person' => 'Jolicode\SchemaOrg\Type\PersonModel', 'Vehicle' => 'Jolicode\SchemaOrg\Type\VehicleModel'];
