...
final class IsStoreOnModel
{
    ...
    public const VALUES = ['OnlineMarketplaceModel' => 'Jolicode\SchemaOrg\Type\OnlineMarketplaceModel'];
    public const TYPES = ['OnlineStore' => 'Jolicode\SchemaOrg\Type\OnlineStoreModel'];
