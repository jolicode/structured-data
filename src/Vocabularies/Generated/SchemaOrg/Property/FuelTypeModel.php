...
final class FuelTypeModel
{
    ...
    public const TYPES = ['EngineSpecification' => 'Jolicode\Vocabularies\SchemaOrg\Type\EngineSpecificationModel', 'Vehicle' => 'Jolicode\Vocabularies\SchemaOrg\Type\VehicleModel'];
