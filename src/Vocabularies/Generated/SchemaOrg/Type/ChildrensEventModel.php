...
final class ChildrensEventModel
{
    public const DESCRIPTION = 'Event type: Children\'s event.';
    public const LABEL = 'ChildrensEvent';
    public const NAME = 'schema:ChildrensEvent';
