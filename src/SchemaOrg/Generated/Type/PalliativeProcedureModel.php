...
final class PalliativeProcedureModel
{
    ...
    public const PARENTS = ['MedicalProcedureModel' => 'Jolicode\SchemaOrg\Type\MedicalProcedureModel', 'MedicalTherapyModel' => 'Jolicode\SchemaOrg\Type\MedicalTherapyModel'];
