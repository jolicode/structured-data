...
final class HealthClubModel
{
    public const DESCRIPTION = 'A health club.';
    public const LABEL = 'HealthClub';
    public const NAME = 'schema:HealthClub';
    public const PARENTS = ['HealthAndBeautyBusinessModel' => 'SchemaOrg\\Type\\HealthAndBeautyBusinessModel', 'SportsActivityLocationModel' => 'SchemaOrg\\Type\\SportsActivityLocationModel'];
