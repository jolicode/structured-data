...
final class MedicalAudienceModel
{
    ...
    public const PARENTS = ['AudienceModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\AudienceModel', 'PeopleAudienceModel' => 'Jolicode\Vocabularies\SchemaOrg\Type\PeopleAudienceModel'];
