...
final class ManuscriptModel
{
    public const DESCRIPTION = 'A book, document, or piece of music written by hand rather than typed or printed.';
    public const LABEL = 'Manuscript';
    public const NAME = 'schema:Manuscript';
