...
final class BusinessEventModel
{
    public const DESCRIPTION = 'Event type: Business event.';
    public const LABEL = 'BusinessEvent';
    public const NAME = 'schema:BusinessEvent';
