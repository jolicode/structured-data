...
final class SomeProductsModel
{
    public const DESCRIPTION = 'A placeholder for multiple similar products of the same kind.';
    public const LABEL = 'SomeProducts';
    public const NAME = 'schema:SomeProducts';
