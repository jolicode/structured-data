...
final class OrderActionModel
{
    public const DESCRIPTION = 'An agent orders an object/product/service to be delivered/sent.';
    public const LABEL = 'OrderAction';
    public const NAME = 'schema:OrderAction';
