...
final class SoftwareApplicationModel
{
    public const DESCRIPTION = 'A software application.';
    public const LABEL = 'SoftwareApplication';
    public const NAME = 'schema:SoftwareApplication';
