...
final class CivicStructureModel
{
    public const DESCRIPTION = 'A public structure, such as a town hall or concert hall.';
    public const LABEL = 'CivicStructure';
    public const NAME = 'schema:CivicStructure';
