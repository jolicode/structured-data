...
final class AuthenticateActionModel
{
    public const DESCRIPTION = 'The action of authenticating into a device or application.';
    public const LABEL = 'AuthenticateAction';
    public const NAME = 'schema:AuthenticateAction';
