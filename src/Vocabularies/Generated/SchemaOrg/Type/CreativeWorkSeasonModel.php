...
final class CreativeWorkSeasonModel
{
    public const DESCRIPTION = 'A media season, e.g. TV, radio, video game etc.';
    public const LABEL = 'CreativeWorkSeason';
    public const NAME = 'schema:CreativeWorkSeason';
