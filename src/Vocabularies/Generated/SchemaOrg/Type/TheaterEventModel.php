...
final class TheaterEventModel
{
    public const DESCRIPTION = 'Event type: Theater performance.';
    public const LABEL = 'TheaterEvent';
    public const NAME = 'schema:TheaterEvent';
