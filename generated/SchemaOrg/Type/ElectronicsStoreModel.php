...
final class ElectronicsStoreModel
{
    public const DESCRIPTION = 'An electronics store.';
    public const LABEL = 'ElectronicsStore';
    public const NAME = 'schema:ElectronicsStore';
